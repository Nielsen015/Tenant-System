...
{
    $main_id = $_GET['id'];
    $sql_update = mysqli_query($connection,"UPDATE individualcopy SET status=1 WHERE id='$main_id'");
}
?>
...
<div class="card shadow mb-4">
  ...
  <div class="card-body">
    ...
    <?php
    $sr_no=1;
        $query = "SELECT * FROM individualcopy WHERE tenant='".$_SESSION['username']."' AND  status=1";
