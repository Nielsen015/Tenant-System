            ...
            <div class="col-md-4 offset-md-4 form">
                <form action="forgot-password.php" method="POST" autocomplete="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="link forget-pass text-center"><a href="signin.php">Back to Sign in</a></div>
                    <div class="link login-link text-center">Tenant But Not Registered? <a href="signup.php">Signup now</a></div>
